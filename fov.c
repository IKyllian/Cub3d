...
static void	step_y_calc(t_window *ptr)
{
	...
	s_x = ptr->player.pos_y;
	s_y = ptr->player.pos_x;
	ptr->player.dist_y = 0;
...
void	put_fov(t_window *ptr)
{
	...
	dx = (ptr->player.nwall_x - ptr->player.x) / len;
	dy = (ptr->player.nwall_y - ptr->player.y) / len;
	x = ptr->player.pos_y + 0.0033;
	y = ptr->player.pos_x + 0.0033;
	i = 1;
